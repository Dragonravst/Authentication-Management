...
const ResetPassword=()=>{
    ...
    const{getUserData,setIsLoggedIn,userData,backendURL}=useContext(AppContext);
    ...
    const handleVerify=()=>{
        ...
        if(otp.length!==6){
        toast.error("Please enter all the 6 digits of the OTP");
        return;
     }
     setOtp(otp);
    ...
    return(
       <div className=" d-flex align-items-center justify-content-center vh-100 position-relative "
        ...
        {!isOtpSubmitted && isEmailSent &&(
               <div className="p-5 rounded-4 shadow bg-white text-dark" style={{ width: "400px" }}>
        ...
        <button className="btn btn-primary w-100 fw-semibold" disabled={loading} onClick={handleVerify} >
          ...
          {isOtpSubmitted && isEmailSent &&(
                <div className="rounded-4 p-4 bg-white text-center"style={{width:'100%',maxWidth:'400px'}}>
                    <h4>New Password</h4>
